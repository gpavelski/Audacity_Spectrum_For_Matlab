...
while toc<30
    ...
    pause(0.0001);
    Spec = SpectrumAnalyst(Algorithm(alg), eWindowFunctions(windowFunc), windowSize, Fs, mySignal', size(mySignal,1), Points, SinTable, BitReversed);
    area(t(1,1:end-1),Spec(1,2:end),'FaceColor', [0.784 0.196 0.588], 'EdgeColor', [0.9 0.39 0.9]);
